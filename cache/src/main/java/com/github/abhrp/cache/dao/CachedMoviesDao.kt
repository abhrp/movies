...
import com.github.abhrp.cache.db.MovieConstants.QUERY_SELECT_SAVED_MOVIES
import com.github.abhrp.cache.db.MovieConstants.UPDATE_SAVED_MOVIE
...
interface CachedMoviesDao {
    ...
    @Query(QUERY_SELECT_SAVED_MOVIES)
    fun getSavedMovies(): Flowable<List<CachedMovie>>

    @Query(UPDATE_SAVED_MOVIE)
    fun setSaveMovie(isSaved: Boolean, movieId: Int)
}